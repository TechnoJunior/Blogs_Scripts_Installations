...
// Database user
define('DC_DBUSER','pulkit_dotcl26');

// Database password
define('DC_DBPASSWORD','S9!34tx-Lp');

// Database name
define('DC_DBNAME','pulkit_dotcl26');

// Tables' prefix
define('DC_DBPREFIX','dcwf_');

// Persistent database connection
define('DC_DBPERSIST', false);

// Crypt key (password storage)
define('DC_MASTER_KEY','0165d599f6e70fd3a0afc057ff61fd91');

// Admin URL. You need to set it for some features.
define('DC_ADMIN_URL','http://127.0.0.1/auto/public_html/DotClear/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM','admin@127.0.0.1');
